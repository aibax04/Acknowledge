...
class CustomLeavePolicy(Base):
    ...
    max_days_per_month = Column(Integer, nullable=True)  # optional cap per month (None = no limit)
    ...
    shared_annual_limit = Column(Integer, nullable=True)  # shared across all policies in the group, per year
